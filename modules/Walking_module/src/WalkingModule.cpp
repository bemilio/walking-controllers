...
bool WalkingModule::updateModule()
{
            ...
            || m_robotState == WalkingFSM::OnTheFly)
    {
        ...
        else
        {
            if(m_robotState == WalkingFSM::OnTheFly)
            {
                iDynTree::VectorDynSize desiredJointInRad( m_robotControlHelper->getActuatedDoFs());
...
bool WalkingModule::onTheFlyStartWalking(const double smoothingTime)
{
    ...
    initialJointValuesInRadYarp.resize(m_robotControlHelper->getActuatedDoFs());
    iDynTree::toYarp(m_robotControlHelper->getJointPosition(), initialJointValuesInRadYarp);
    ...
    m_desiredJointInRadYarp.resize(m_robotControlHelper->getActuatedDoFs());
