...
public:
     ...
     * @return true/false in case of success/failure.
     */
    bool setReferenceValues(const iDynTree::VectorDynSize& desiredJointPosition,
                            const iDynTree::Transform& desiredBaseTranformation,
                            const iDynTree::VectorDynSize& desiredRobotVelocity);
     ...
     */
    const iDynTree::VectorDynSize& getControllerOutput() const;
